<template>
  <div>
    ...
    <div class="container-fluid">
      ...
      <figure class="card">
        <figcaption>
          <h2>Michael <span>roberto</span></h2>
          <h3>Jurusan IPA</h3>
        </figcaption>
        <img src="user.png" />
        <div class="email">kathkaren21@gmail.com</div>
      </figure>

      <br />
      <br />
      <br />
      <router-link to="/Ujian">
      <figure class="card"><button class="tombol">Mulai Ujian!</button></figure>
      </router-link>
      <br />
      <br />
      <br />
...
.tombol{background-color:#e91e63;}
