            ...
            <div class="col-lg-4 col-md-4 col-sm-4 ml-auto mr-auto">
                <div class="card">
                    <div class="card-header card-header-rose">
                        <center>
                            <h5 class="card-title">Silahkan isi form registrasi</h5>
                        </center>
                </div>
                <form id="login-form" @submit.prevent="pressed">
                          <div class="form-group field-loginform-username required bmd-form-group validating">
                              <input type="email" v-model="email" id="loginform-username" class="form-control" placeholder="Email" aria-required="true" aria-invalid="true">
                          </div>
                          <div class="form-group field-loginform-username required bmd-form-group validating">
                              <input type="password" v-model="password" id="loginform-username" class="form-control" placeholder="Password" aria-required="true" aria-invalid="true">
                          </div>
                          <button type="submit" class="btn btn-rose btn-block btn-flat btn-round" name="register_button">Register</button>
