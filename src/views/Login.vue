            ...
            <div class="col-lg-4 col-md-4 col-sm-4 ml-auto mr-auto">
                <div class="card">
                    <div class="card-header card-header-rose">
                        <center>
                            <h5 class="card-title">Selamat Datang di <b>Try Out Online Prosus Inten</b></h5>
                        </center>
                    </div>
                    <div class="card-body">
                        <form id="login-form" @submit.prevent="pressed" action="/user" method="post">
                            <div class="form-group field-loginform-username required bmd-form-group validating">

                        <input type="text" id="loginform-username" class="form-control" name="LoginForm[username]"  placeholder="Email" aria-required="true" aria-invalid="true">


                    </div>
            <div class="form-group field-loginform-password required bmd-form-group">
            ...
            <div class="invalid-feedback"></div>
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <button type="submit" class="btn btn-rose btn-block btn-flat btn-round" name="login-button">Login</button>
                                    </router-link>                                
                                    </div>
                            </div>

                        </form>
                        <div class="col-lg-offset-1" style="color: primary">Jika belum punya akun, segera<router-link to="/register" class="nav-link">Klik disini untuk Register</router-link>                       
                    </div>
                    </div>
                </div>
...
.container1{
  ...
  box-shadow: 13px 12px 23px #ececec;
}
.container2 .alert-success {
  color: #006249;
